...
export default function OCRResultScreen() {
  ...
  const simulateOCRProcessing = async () => {
    try {
      console.log('[OCR_RESULT] Starting OCR processing');
      setLoading(true);
      ...
      const mockExtracted: ExtractedData = {
        amount: 125000,
        merchantName: 'TechGearVietnam Store',
        date: defaultDate,
        description: 'Electronics Purchase',
      };

      console.log('[OCR_RESULT] OCR extraction complete:', mockExtracted);

      setExtractedData(mockExtracted);
      setAmountInput(mockExtracted.amount.toString());
      setFormData(prev => ({
        ...prev,
        amount: mockExtracted.amount.toString(),
        date: defaultDate,
        note: mockExtracted.description,
      }));
    } catch (error) {
